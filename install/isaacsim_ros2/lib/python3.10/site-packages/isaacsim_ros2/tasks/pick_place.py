...
class PickPlaceBase(ABC, BaseTask):
    ...
    def __init__(
        ...
        if self._cube_initial_position is None:
            self._cube_initial_position = np.array([-0.6, -0.3, 0.3]) / get_stage_units()
...
class PickPlace(PickPlaceBase):
    ...
    Args:
        name (str, optional): [description]. Defaults to "fr5_pick_place".
        cube_initial_position (Optional[np.ndarray], optional): [description]. Defaults to None.
        cube_initial_orientation (Optional[np.ndarray], optional): [description]. Defaults to None.
        target_position (Optional[np.ndarray], optional): [description]. Defaults to None.
        cube_size (Optional[np.ndarray], optional): [description]. Defaults to None.
    ...
    def set_robot(self) -> FR5:
        ...
        return FR5(prim_path=fr5_prim_path,
                   name=fr5_robot_name,
