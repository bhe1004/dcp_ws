...
class GripperRealActionServer : public ActionServerBase
{
public:
    ...
    GripperRealActionServer(rclcpp::Node::SharedPtr node, const std::string& name, std::shared_ptr<RobotController::FairinoWrapper> mu);
