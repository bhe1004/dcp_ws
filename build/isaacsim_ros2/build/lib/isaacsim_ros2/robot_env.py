...
while simulation_app.is_running():
    ...
    if world.is_playing():
        ...
        # # Get Camera Data
        # try:
        #     rgb_image_fixed_front = observations["sensor"]["camera"]["fixed"]["front"]["rgb"]
        #     rgb_image_fixed_back = observations["sensor"]["camera"]["fixed"]["back"]["rgb"]
        #     rgb_image_wrist = observations["sensor"]["camera"]["wrist"]["rgb"]
            
        #     depth_image_fixed_front = observations["sensor"]["camera"]["fixed"]["front"]["depth"]
        #     depth_image_fixed_back = observations["sensor"]["camera"]["fixed"]["back"]["depth"]
        #     depth_image_wrist = observations["sensor"]["camera"]["wrist"]["depth"]
