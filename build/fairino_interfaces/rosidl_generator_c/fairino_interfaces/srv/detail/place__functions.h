...
#ifndef FAIRINO_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
#define FAIRINO_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
 ...
 * calls
 * fairino_interfaces__srv__Place_Request__init().
...
/**
 * It calls
 * fairino_interfaces__srv__Place_Request__fini()
 ...
 * fairino_interfaces__srv__Place_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fairino_interfaces__srv__Place_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * fairino_interfaces__srv__Place_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fairino_interfaces
...
/**
 * It calls
 * fairino_interfaces__srv__Place_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_fairino_interfaces
...
/**
 * It allocates the memory for the array and calls
 * fairino_interfaces__srv__Place_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fairino_interfaces
...
/**
 * It calls
 * fairino_interfaces__srv__Place_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FAIRINO_INTERFACES__SRV__DETAIL__PLACE__FUNCTIONS_H_
