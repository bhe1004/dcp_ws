...
fairino_interfaces__action__JointPosture_Goal__init(fairino_interfaces__action__JointPosture_Goal * msg)
{
  ...
  // target_joints
  if (!sensor_msgs__msg__JointState__init(&msg->target_joints)) {
    fairino_interfaces__action__JointPosture_Goal__fini(msg);
    return false;
  }
  // duration
  return true;
...
fairino_interfaces__action__JointPosture_Goal__fini(fairino_interfaces__action__JointPosture_Goal * msg)
{
  ...
  // target_joints
  sensor_msgs__msg__JointState__fini(&msg->target_joints);
  // duration
}
...
fairino_interfaces__action__JointPosture_Goal__create()
{
  ...
  fairino_interfaces__action__JointPosture_Goal * msg = (fairino_interfaces__action__JointPosture_Goal *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_Goal));
  bool success = fairino_interfaces__action__JointPosture_Goal__init(msg);
  if (!success) {
...
fairino_interfaces__action__JointPosture_Goal__Sequence__init(fairino_interfaces__action__JointPosture_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Goal * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_Goal *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_Goal__fini(&data[i - 1]);
      }
...
fairino_interfaces__action__JointPosture_Goal__Sequence__fini(fairino_interfaces__action__JointPosture_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Goal__Sequence * array = (fairino_interfaces__action__JointPosture_Goal__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_Goal__Sequence__init(array, size);
  if (!success) {
...
fairino_interfaces__action__JointPosture_Goal__Sequence__destroy(fairino_interfaces__action__JointPosture_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_Goal__Sequence__are_equal(const fairino_interfaces__action__JointPosture_Goal__Sequence * lhs, const fairino_interfaces__action__JointPosture_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_Goal * data =
      (fairino_interfaces__action__JointPosture_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Result * msg = (fairino_interfaces__action__JointPosture_Result *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_Result));
  bool success = fairino_interfaces__action__JointPosture_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_Result__destroy(fairino_interfaces__action__JointPosture_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    fairino_interfaces__action__JointPosture_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
fairino_interfaces__action__JointPosture_Result__Sequence__init(fairino_interfaces__action__JointPosture_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Result * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_Result *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_Result__Sequence__fini(fairino_interfaces__action__JointPosture_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Result__Sequence * array = (fairino_interfaces__action__JointPosture_Result__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_Result__Sequence__destroy(fairino_interfaces__action__JointPosture_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_Result__Sequence__are_equal(const fairino_interfaces__action__JointPosture_Result__Sequence * lhs, const fairino_interfaces__action__JointPosture_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_Result * data =
      (fairino_interfaces__action__JointPosture_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Feedback * msg = (fairino_interfaces__action__JointPosture_Feedback *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_Feedback));
  bool success = fairino_interfaces__action__JointPosture_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_Feedback__destroy(fairino_interfaces__action__JointPosture_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    fairino_interfaces__action__JointPosture_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
fairino_interfaces__action__JointPosture_Feedback__Sequence__init(fairino_interfaces__action__JointPosture_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Feedback * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_Feedback *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_Feedback__Sequence__fini(fairino_interfaces__action__JointPosture_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_Feedback__Sequence * array = (fairino_interfaces__action__JointPosture_Feedback__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_Feedback__Sequence__destroy(fairino_interfaces__action__JointPosture_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_Feedback__Sequence__are_equal(const fairino_interfaces__action__JointPosture_Feedback__Sequence * lhs, const fairino_interfaces__action__JointPosture_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_Feedback * data =
      (fairino_interfaces__action__JointPosture_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
fairino_interfaces__action__JointPosture_SendGoal_Request__init(fairino_interfaces__action__JointPosture_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    fairino_interfaces__action__JointPosture_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!fairino_interfaces__action__JointPosture_Goal__init(&msg->goal)) {
    fairino_interfaces__action__JointPosture_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
fairino_interfaces__action__JointPosture_SendGoal_Request__fini(fairino_interfaces__action__JointPosture_SendGoal_Request * msg)
{
  ...
  // goal
  fairino_interfaces__action__JointPosture_Goal__fini(&msg->goal);
}
...
fairino_interfaces__action__JointPosture_SendGoal_Request__are_equal(const fairino_interfaces__action__JointPosture_SendGoal_Request * lhs, const fairino_interfaces__action__JointPosture_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!fairino_interfaces__action__JointPosture_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Request * msg = (fairino_interfaces__action__JointPosture_SendGoal_Request *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_SendGoal_Request));
  bool success = fairino_interfaces__action__JointPosture_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__init(fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Request * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_SendGoal_Request *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__fini(fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * array = (fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__destroy(fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence__are_equal(const fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * lhs, const fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_SendGoal_Request * data =
      (fairino_interfaces__action__JointPosture_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
fairino_interfaces__action__JointPosture_SendGoal_Response__init(fairino_interfaces__action__JointPosture_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    fairino_interfaces__action__JointPosture_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Response * msg = (fairino_interfaces__action__JointPosture_SendGoal_Response *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_SendGoal_Response));
  bool success = fairino_interfaces__action__JointPosture_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__init(fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Response * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_SendGoal_Response *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__fini(fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * array = (fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__destroy(fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence__are_equal(const fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * lhs, const fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_SendGoal_Response * data =
      (fairino_interfaces__action__JointPosture_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
fairino_interfaces__action__JointPosture_GetResult_Request__init(fairino_interfaces__action__JointPosture_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    fairino_interfaces__action__JointPosture_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Request * msg = (fairino_interfaces__action__JointPosture_GetResult_Request *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_GetResult_Request));
  bool success = fairino_interfaces__action__JointPosture_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__init(fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Request * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_GetResult_Request *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__fini(fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * array = (fairino_interfaces__action__JointPosture_GetResult_Request__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__destroy(fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_GetResult_Request__Sequence__are_equal(const fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * lhs, const fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_GetResult_Request * data =
      (fairino_interfaces__action__JointPosture_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
fairino_interfaces__action__JointPosture_GetResult_Response__init(fairino_interfaces__action__JointPosture_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!fairino_interfaces__action__JointPosture_Result__init(&msg->result)) {
    fairino_interfaces__action__JointPosture_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
fairino_interfaces__action__JointPosture_GetResult_Response__fini(fairino_interfaces__action__JointPosture_GetResult_Response * msg)
{
  ...
  // status
  // result
  fairino_interfaces__action__JointPosture_Result__fini(&msg->result);
}
...
fairino_interfaces__action__JointPosture_GetResult_Response__are_equal(const fairino_interfaces__action__JointPosture_GetResult_Response * lhs, const fairino_interfaces__action__JointPosture_GetResult_Response * rhs)
{
  ...
  // result
  if (!fairino_interfaces__action__JointPosture_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Response * msg = (fairino_interfaces__action__JointPosture_GetResult_Response *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_GetResult_Response));
  bool success = fairino_interfaces__action__JointPosture_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__init(fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Response * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_GetResult_Response *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__fini(fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * array = (fairino_interfaces__action__JointPosture_GetResult_Response__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__destroy(fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_GetResult_Response__Sequence__are_equal(const fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * lhs, const fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_GetResult_Response * data =
      (fairino_interfaces__action__JointPosture_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
fairino_interfaces__action__JointPosture_FeedbackMessage__init(fairino_interfaces__action__JointPosture_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    fairino_interfaces__action__JointPosture_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!fairino_interfaces__action__JointPosture_Feedback__init(&msg->feedback)) {
    fairino_interfaces__action__JointPosture_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
fairino_interfaces__action__JointPosture_FeedbackMessage__fini(fairino_interfaces__action__JointPosture_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  fairino_interfaces__action__JointPosture_Feedback__fini(&msg->feedback);
}
...
fairino_interfaces__action__JointPosture_FeedbackMessage__are_equal(const fairino_interfaces__action__JointPosture_FeedbackMessage * lhs, const fairino_interfaces__action__JointPosture_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!fairino_interfaces__action__JointPosture_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_FeedbackMessage * msg = (fairino_interfaces__action__JointPosture_FeedbackMessage *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fairino_interfaces__action__JointPosture_FeedbackMessage));
  bool success = fairino_interfaces__action__JointPosture_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__init(fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_FeedbackMessage * data = NULL;

  if (size) {
    data = (fairino_interfaces__action__JointPosture_FeedbackMessage *)allocator.zero_allocate(size, sizeof(fairino_interfaces__action__JointPosture_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fairino_interfaces__action__JointPosture_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        fairino_interfaces__action__JointPosture_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__fini(fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      fairino_interfaces__action__JointPosture_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * array = (fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence *)allocator.allocate(sizeof(fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__destroy(fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence__are_equal(const fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * lhs, const fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fairino_interfaces__action__JointPosture_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fairino_interfaces__action__JointPosture_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fairino_interfaces__action__JointPosture_FeedbackMessage * data =
      (fairino_interfaces__action__JointPosture_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fairino_interfaces__action__JointPosture_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fairino_interfaces__action__JointPosture_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!fairino_interfaces__action__JointPosture_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
