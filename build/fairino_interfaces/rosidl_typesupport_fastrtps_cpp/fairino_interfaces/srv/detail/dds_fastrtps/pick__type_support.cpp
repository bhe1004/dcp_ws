...
#include "fairino_interfaces/srv/detail/pick__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fairino_interfaces::srv::Pick_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fairino_interfaces::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fairino_interfaces::srv::Pick_Request *>(
    untyped_ros_message);
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fairino_interfaces, srv, Pick_Request)() {
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_interfaces
cdr_serialize(
  const fairino_interfaces::srv::Pick_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: is_completed
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fairino_interfaces::srv::Pick_Response & ros_message)
{
  // Member: is_completed
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces::srv::Pick_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fairino_interfaces::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fairino_interfaces::srv::Pick_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fairino_interfaces, srv, Pick_Response)() {
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick_Response__handle;
}
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fairino_interfaces, srv, Pick)() {
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Pick__handle;
}
