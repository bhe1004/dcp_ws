...
#include "fairino_interfaces/srv/detail/place__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fairino_interfaces::srv::Place_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fairino_interfaces::srv::Place_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fairino_interfaces::srv::Place_Request *>(
    untyped_ros_message);
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Place_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces::srv::Place_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fairino_interfaces::srv::Place_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fairino_interfaces::srv::Place_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Place_Response__handle;
}
...
{
  return &fairino_interfaces::srv::typesupport_fastrtps_cpp::_Place__handle;
}
