...
static const _Pick_Request_type_support_symbol_names_t _Pick_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, srv, Pick_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fairino_interfaces, srv, Pick_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fairino_interfaces, srv, Pick_Request)() {
  return &::fairino_interfaces::srv::rosidl_typesupport_c::Pick_Request_message_type_support_handle;
}
...
static const _Pick_Response_type_support_symbol_names_t _Pick_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, srv, Pick_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fairino_interfaces, srv, Pick_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fairino_interfaces, srv, Pick_Response)() {
  return &::fairino_interfaces::srv::rosidl_typesupport_c::Pick_Response_message_type_support_handle;
}
...
static const _Pick_type_support_symbol_names_t _Pick_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, srv, Pick)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fairino_interfaces, srv, Pick)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, fairino_interfaces, srv, Pick)() {
  return &::fairino_interfaces::srv::rosidl_typesupport_c::Pick_service_type_support_handle;
}
