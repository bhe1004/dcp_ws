...
{
public:
  explicit Init_Pick_Request_target_pose(::fairino_interfaces::srv::Pick_Request & msg)
  : msg_(msg)
  {}
...
class Init_Pick_Request_client_id
{
public:
  Init_Pick_Request_client_id()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Pick_Request_target_pose client_id(::fairino_interfaces::srv::Pick_Request::_client_id_type arg)
  {
    msg_.client_id = std::move(arg);
    return Init_Pick_Request_target_pose(msg_);
  }
...
{
  return fairino_interfaces::srv::builder::Init_Pick_Request_client_id();
}
