...
class Metaclass_Place(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from fairino_interfaces.srv import _place
...
class Place(metaclass=Metaclass_Place):
    from fairino_interfaces.srv._place import Place_Request as Request
    from fairino_interfaces.srv._place import Place_Response as Response
