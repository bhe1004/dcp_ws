...
#include "fairino_interfaces/action/detail/gripper__rosidl_typesupport_fastrtps_c.h"
...
using _Gripper_Goal__ros_msg_type = fairino_interfaces__action__Gripper_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: grasp
  {
    cdr << (ros_message->grasp ? true : false);
  }

  // Field name: position_percentage
  {
    cdr << ros_message->position_percentage;
  }
  ...
  // Field name: torque_percentage
  {
    cdr << ros_message->torque_percentage;
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: grasp
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->grasp = tmp ? true : false;
  }
...
size_t get_serialized_size_fairino_interfaces__action__Gripper_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name grasp
  {
    size_t item_size = sizeof(ros_message->grasp);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name position_percentage
  {
    size_t item_size = sizeof(ros_message->position_percentage);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name speed_percentage
  ...
  // field.name torque_percentage
  {
    size_t item_size = sizeof(ros_message->torque_percentage);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Gripper_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fairino_interfaces__action__Gripper_Goal;
    is_plain =
      (
      offsetof(DataType, torque_percentage) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Gripper_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Goal)() {
...
using _Gripper_Result__ros_msg_type = fairino_interfaces__action__Gripper_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_Result__ros_msg_type * ros_message = static_cast<const _Gripper_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_Result;
    is_plain =
      (
...
static size_t _Gripper_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Result)() {
...
using _Gripper_Feedback__ros_msg_type = fairino_interfaces__action__Gripper_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_Feedback__ros_msg_type * ros_message = static_cast<const _Gripper_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_Feedback;
    is_plain =
      (
...
static size_t _Gripper_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Feedback)() {
...
// already included above
// #include "fairino_interfaces/action/detail/gripper__functions.h"  // goal
...
using _Gripper_SendGoal_Request__ros_msg_type = fairino_interfaces__action__Gripper_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Gripper_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fairino_interfaces__action__Gripper_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_fairino_interfaces__action__Gripper_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_SendGoal_Request;
    is_plain =
      (
...
static size_t _Gripper_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_SendGoal_Request)() {
...
using _Gripper_SendGoal_Response__ros_msg_type = fairino_interfaces__action__Gripper_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Gripper_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_SendGoal_Response;
    is_plain =
      (
...
static size_t _Gripper_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_SendGoal)() {
...
using _Gripper_GetResult_Request__ros_msg_type = fairino_interfaces__action__Gripper_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Gripper_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_GetResult_Request;
    is_plain =
      (
...
static size_t _Gripper_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_GetResult_Request)() {
...
// already included above
// #include "fairino_interfaces/action/detail/gripper__functions.h"  // result
...
using _Gripper_GetResult_Response__ros_msg_type = fairino_interfaces__action__Gripper_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Gripper_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fairino_interfaces__action__Gripper_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_fairino_interfaces__action__Gripper_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_GetResult_Response;
    is_plain =
      (
...
static size_t _Gripper_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_GetResult)() {
...
// already included above
// #include "fairino_interfaces/action/detail/gripper__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Gripper_FeedbackMessage__ros_msg_type = fairino_interfaces__action__Gripper_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t get_serialized_size_fairino_interfaces__action__Gripper_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gripper_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Gripper_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_fairino_interfaces__action__Gripper_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_fairino_interfaces__action__Gripper_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fairino_interfaces
size_t max_serialized_size_fairino_interfaces__action__Gripper_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_fairino_interfaces__action__Gripper_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_interfaces__action__Gripper_FeedbackMessage;
    is_plain =
      (
...
static size_t _Gripper_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fairino_interfaces__action__Gripper_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fairino_interfaces, action, Gripper_FeedbackMessage)() {
